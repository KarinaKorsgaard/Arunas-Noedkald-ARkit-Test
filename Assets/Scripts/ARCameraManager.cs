...
public class ARCameraManager : MonoBehaviour {
	...
	void OnEnable(){
		EventManager.StartListening ("ResetTracking", ResetTracking);
		EventManager.StartListening ("PauseTracking",PauseTracking);
	}

	void OnDisable(){
		EventManager.StopListening ("ResetTracking", ResetTracking);
		EventManager.StopListening ("PauseTracking",PauseTracking);
	}
